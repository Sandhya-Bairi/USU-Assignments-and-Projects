 ...
 *
 */
public class PersonComparison3Strategy extends PersonComparisonStrategy {
	
	/* (non-Javadoc)
	 * @see com.usu.person.comparison.PersonComparisonStrategy#comparePersons(java.util.List)
	 * This method provides the implementation for person comparison on third condition
	 */
