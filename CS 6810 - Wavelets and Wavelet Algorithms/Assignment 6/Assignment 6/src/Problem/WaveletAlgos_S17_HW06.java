...
public class WaveletAlgos_S17_HW06 {
    ...
    public static void main(String[] args) {
    	...
    	createScaledImageOf2DHWT("input\\ornament_01.jpg", "output\\ornament_01_2_scale.jpg", 2);
    	createScaledImageOf2DHWT("input\\ornament_01.jpg", "output\\ornament_01_3_scale.jpg", 3);
    	createScaledImageOf2DHWT("input\\ornament_01.jpg", "output\\ornament_01_4_scale.jpg", 4);
    }
